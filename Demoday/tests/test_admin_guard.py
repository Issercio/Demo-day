...
class AdminGuardTestCase(unittest.TestCase):
    ...
    def test_admin_page_stays_clean_without_popup(self):
        ...
        self.assertIn('renderInvoiceBody', html)
        self.assertIn('printOrderInvoice', html)
        self.assertIn('Commandes et factures', html)
        self.assertIn('order-invoice', html)
        self.assertIn('Imprimer la facture', html)
        self.assertIn('data-order-print', html)
        self.assertNotIn('invoice.pdf?email=', html)
        self.assertIn('invoice-logo', html)
        self.assertIn('invoice-thanks', html)
        self.assertIn('Merci de votre confiance', html)
        self.assertIn('FAC-', html)
        self.assertIn('Boutique florale en ligne', html)
        self.assertIn("rawRef.indexOf('pi_') === 0", html)
